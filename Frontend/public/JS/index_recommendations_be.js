$(document).ready(function () {
	...
	$.ajax({
		url: "http://localhost:8000/api/produkt/empfehlung/",
		method: "get",
		dataType: "json"
		...
		content += '<h3 id="our_products">Unsere Empfehlung</h3><br><br>';
		content += '<div id="myCarousel1" class="carousel slide" data-ride="carousel" data-interval="0">';
		...
		content += '</div>';
		content += '</div>';
		content += '<a class="carousel-control-prev bg-secondary col-sm-1" id="arrow" href="#myCarousel1"role="button" data-slide="prev">';
		content += '<span class="carousel-control-prev-icon" aria-hidden="true"></span>';
		content += '<span class="sr-only">Previous</span>';
		content += '</a>';
		content += '<a class="carousel-control-next bg-secondary col-sm-1" id="arrow" href="#myCarousel1"role="button" data-slide="next">';
