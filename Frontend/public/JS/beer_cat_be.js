...
$(document).ready(function () {
    ...
    $.ajax({
        url: "http://localhost:8000/api/produkt/gibkategorie/2",
        method: "get",
        dataType: "json"
        ...
        content += '<a href="product-detail.html" id="product_name" onclick="checkCookie(' + obj.id.toString() + ')" title="Produktdetails">';
